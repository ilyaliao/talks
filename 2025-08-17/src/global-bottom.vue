<!--
  Polygon Blur Glow Effect System

  Inspired by: @pi0 @Atinux

  Props:
    - glow: 'left' | 'right' | 'top' | 'bottom' | 'full'
      Polygon distribution
    - glowOpacity: number
      Polygon opacity (default: 0.4)
    - glowHue: number
      Polygon hue shift (default: 0)
    - glowSeed: string | false
      Seed for random distribution ('default' or false for random each time)
-->
...
<template>
  ...
  >
    <div
      class="clip bg-gradient-to-r from-[rgb(56,189,248)] to-[rgb(3,105,161)]"
    ...
    />
    <div
      class="clip bg-gradient-to-t from-[rgba(56,189,248,0.8)] to-[rgba(3,105,161,0.2)]"
